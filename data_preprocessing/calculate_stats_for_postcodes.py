...
parser.add_argument("--osm_from_pickle", help="load OSM panels coordinates from file instead of querying OSM",
                    action="store_true")
...
panels_from_OSM_raw = func.getSolarPanelsFromOSM(osm_from_pickle=args.osm_from_pickle)
